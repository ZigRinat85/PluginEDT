...
- Добавлены команды хранилища в навигатор EDT: захватить, поместить,
снять захват и обновить состояние захвата.
- Обновление состояния захвата перечитывает локальные отметки плагина
и выводит диагностику источника внешних захватов.
- Добавлено подключение проекта к хранилищу из формы настроек.
